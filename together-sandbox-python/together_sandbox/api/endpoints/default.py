...
class DefaultClient(DefaultClientProtocol):
        ...
        match response.status_code:
            case 200:
                return structure_from_dict(
                    response.json(), PreviewTokenRevokeAllResponse
                )
            case _:
                raise HTTPError(
                    response=response,
    ...
    async def preview_token_create(
        ...
        json_body: PreviewTokenCreateRequest | None = DataclassSerializer.serialize(
            body
        )
    ...
    async def preview_token_update(
        ...
        json_body: PreviewTokenUpdateRequest | None = DataclassSerializer.serialize(
            body
        )
