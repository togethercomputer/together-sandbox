...
def _get_kwargs(
    id: str,
    *,
    body: PreviewTokenCreateRequest | Unset = UNSET,
) -> dict[str, Any]:
...
) -> PreviewTokenCreateResponse | None:
    if response.status_code == 201:
        response_201 = PreviewTokenCreateResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PreviewTokenCreateRequest | Unset):
