...
def _get_kwargs(
    *,
    body: PreviewHostRequest | Unset = UNSET,
) -> dict[str, Any]:
...
) -> PreviewHostListResponse | None:
    if response.status_code == 201:
        response_201 = PreviewHostListResponse.from_dict(response.json())
