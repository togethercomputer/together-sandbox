...
from ...models.vm_update_hibernation_timeout_request_2 import (
    VmUpdateHibernationTimeoutRequest2,
)
from ...models.vm_update_hibernation_timeout_response_2 import (
...
class MockVmClient:
    ...
    async def vm_assign_tag_alias(
        ...
        raise NotImplementedError(
            "MockVmClient.vm_assign_tag_alias() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_list_clusters(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_list_clusters() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_list_running_vms(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_list_running_vms() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_create_tag(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_create_tag() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_delete(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_delete() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_hibernate(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_hibernate() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_update_hibernation_timeout(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_update_hibernation_timeout() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_create_session(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_create_session() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_shutdown(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_shutdown() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_update_specs(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_update_specs() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_start(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_start() not implemented. Override this method in your test subclass."
        )
    ...
    async def vm_update_specs_2(
        ...
        """
        raise NotImplementedError(
            "MockVmClient.vm_update_specs_2() not implemented. Override this method in your test subclass."
        )
