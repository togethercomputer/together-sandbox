...
class MockDefaultClient:
    ...
    body: WorkspaceCreateRequest | None = None,
        ...
        """
        raise NotImplementedError("MockClient_Client.workspace_create() not implemented. Override this method in your test subclass.")
    ...
    body: TokenCreateRequest | None = None,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockClient_Client.token_create() not implemented. Override this method in your test subclass.")
    ...
    body: TokenUpdateRequest | None = None,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockClient_Client.token_update() not implemented. Override this method in your test subclass.")
    ...
    id_: str,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockClient_Client.preview_token_revoke_all() not implemented. Override this method in your test subclass.")
    ...
    id_: str,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockClient_Client.preview_token_list() not implemented. Override this method in your test subclass.")
    ...
    body: PreviewTokenCreateRequest | None = None,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockClient_Client.preview_token_create() not implemented. Override this method in your test subclass.")
    ...
    body: PreviewTokenUpdateRequest | None = None,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockClient_Client.preview_token_update() not implemented. Override this method in your test subclass.")
    ...
    self,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockClient_Client.preview_host_list() not implemented. Override this method in your test subclass.")
    ...
    body: PreviewHostRequest | None = None,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockClient_Client.preview_host_create() not implemented. Override this method in your test subclass.")
    ...
    body: PreviewHostRequest | None = None,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockClient_Client.preview_host_update() not implemented. Override this method in your test subclass.")