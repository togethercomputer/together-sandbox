...
if TYPE_CHECKING:
    from ..models.vm_create_session_response_data_permissions import VMCreateSessionResponseDataPermissions
...
class VMCreateSessionResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        permissions = VMCreateSessionResponseDataPermissions.from_dict(d.pop("permissions"))
