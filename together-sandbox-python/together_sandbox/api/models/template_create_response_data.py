...
if TYPE_CHECKING:
    from ..models.template_create_response_data_sandboxes_item import TemplateCreateResponseDataSandboxesItem
...
class TemplateCreateResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for sandboxes_item_data in _sandboxes:
            sandboxes_item = TemplateCreateResponseDataSandboxesItem.from_dict(sandboxes_item_data)
