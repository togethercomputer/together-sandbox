...
if TYPE_CHECKING:
    ...
    from ..models.token_update_response_errors_item_type_1 import TokenUpdateResponseErrorsItemType1
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _errors is not UNSET:
            ...
            for errors_item_data in _errors:
                ...
                def _parse_errors_item(data: object) -> str | TokenUpdateResponseErrorsItemType1:
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        errors_item_type_1 = TokenUpdateResponseErrorsItemType1.from_dict(data)
