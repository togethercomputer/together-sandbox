...
if TYPE_CHECKING:
    from ..models.vm_list_clusters_response_data_clusters_item import VMListClustersResponseDataClustersItem
...
class VMListClustersResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for clusters_item_data in _clusters:
            clusters_item = VMListClustersResponseDataClustersItem.from_dict(clusters_item_data)
