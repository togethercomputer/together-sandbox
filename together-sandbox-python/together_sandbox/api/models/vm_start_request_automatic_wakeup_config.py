...
T = TypeVar("T", bound="VMStartRequestAutomaticWakeupConfig")


@_attrs_define
class VMStartRequestAutomaticWakeupConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vm_start_request_automatic_wakeup_config = cls(
            http=http,
            websocket=websocket,
        )

        vm_start_request_automatic_wakeup_config.additional_properties = d
        return vm_start_request_automatic_wakeup_config
