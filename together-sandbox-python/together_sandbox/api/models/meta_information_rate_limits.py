...
if TYPE_CHECKING:
    from ..models.meta_information_rate_limits_concurrent_vms import (
        MetaInformationRateLimitsConcurrentVms,
    )
    from ..models.meta_information_rate_limits_requests_hourly import (
        MetaInformationRateLimitsRequestsHourly,
    )
    from ..models.meta_information_rate_limits_sandboxes_hourly import (
...
class MetaInformationRateLimits:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        concurrent_vms = MetaInformationRateLimitsConcurrentVms.from_dict(
            d.pop("concurrent_vms")
        )

        requests_hourly = MetaInformationRateLimitsRequestsHourly.from_dict(
            d.pop("requests_hourly")
        )

        sandboxes_hourly = MetaInformationRateLimitsSandboxesHourly.from_dict(
            d.pop("sandboxes_hourly")
        )
