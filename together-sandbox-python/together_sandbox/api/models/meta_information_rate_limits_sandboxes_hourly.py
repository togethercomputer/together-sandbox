...
T = TypeVar("T", bound="MetaInformationRateLimitsSandboxesHourly")
...
class MetaInformationRateLimitsSandboxesHourly:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta_information_rate_limits_sandboxes_hourly = cls(
            limit=limit,
            remaining=remaining,
            reset=reset,
        )

        meta_information_rate_limits_sandboxes_hourly.additional_properties = d
        return meta_information_rate_limits_sandboxes_hourly
