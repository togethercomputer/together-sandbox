...
T = TypeVar("T", bound="PreviewTokenCreateRequest")
...
class PreviewTokenCreateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        preview_token_create_request = cls(
            expires_at=expires_at,
        )

        preview_token_create_request.additional_properties = d
        return preview_token_create_request
