...
if TYPE_CHECKING:
    from ..models.vm_start_request_automatic_wakeup_config import VMStartRequestAutomaticWakeupConfig
...
class VMStartRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_automatic_wakeup_config, Unset):
            ...
            automatic_wakeup_config = VMStartRequestAutomaticWakeupConfig.from_dict(_automatic_wakeup_config)
