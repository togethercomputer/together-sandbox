...
if TYPE_CHECKING:
    ...
    from ..models.preview_token_list_response_errors_item_type_1 import PreviewTokenListResponseErrorsItemType1
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.errors, Unset):
            ...
            for errors_item_data in self.errors:
                ...
                if isinstance(errors_item_data, PreviewTokenListResponseErrorsItemType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _errors is not UNSET:
            ...
            for errors_item_data in _errors:
                ...
                def _parse_errors_item(data: object) -> PreviewTokenListResponseErrorsItemType1 | str:
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        errors_item_type_1 = PreviewTokenListResponseErrorsItemType1.from_dict(data)
