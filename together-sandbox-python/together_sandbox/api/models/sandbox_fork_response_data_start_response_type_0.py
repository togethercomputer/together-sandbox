...
T = TypeVar("T", bound="SandboxForkResponseDataStartResponseType0")


@_attrs_define
class SandboxForkResponseDataStartResponseType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sandbox_fork_response_data_start_response_type_0 = cls(
            bootup_type=bootup_type,
            cluster=cluster,
            id=id,
            latest_pitcher_version=latest_pitcher_version,
        ...
        sandbox_fork_response_data_start_response_type_0.additional_properties = d
        return sandbox_fork_response_data_start_response_type_0
