...
if TYPE_CHECKING:
    ...
    from ..models.sandbox_create_request_npm_dependencies import (
...
class SandboxCreateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.sandbox_create_request_settings import (
        ...
        if isinstance(_npm_dependencies, Unset):
            ...
            npm_dependencies = SandboxCreateRequestNpmDependencies.from_dict(
                _npm_dependencies
            )
