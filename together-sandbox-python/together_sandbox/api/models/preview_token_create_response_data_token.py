...
T = TypeVar("T", bound="PreviewTokenCreateResponseDataToken")
...
class PreviewTokenCreateResponseDataToken:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        preview_token_create_response_data_token = cls(
            expires_at=expires_at,
            last_used_at=last_used_at,
            token_id=token_id,
            token_prefix=token_prefix,
        ...
        preview_token_create_response_data_token.additional_properties = d
        return preview_token_create_response_data_token
