...
if TYPE_CHECKING:
    from ..models.sandbox_fork_response_data_start_response_type_0 import (
...
class SandboxForkResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_start_response(
            data: object,
        ) -> None | SandboxForkResponseDataStartResponseType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                start_response_type_0 = (
                    SandboxForkResponseDataStartResponseType0.from_dict(data)
                )
