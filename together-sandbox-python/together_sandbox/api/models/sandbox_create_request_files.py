...
if TYPE_CHECKING:
    from ..models.sandbox_create_request_files_additional_property import SandboxCreateRequestFilesAdditionalProperty
...
class SandboxCreateRequestFiles:
    ...
    additional_properties: dict[str, SandboxCreateRequestFilesAdditionalProperty] = _attrs_field(
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = SandboxCreateRequestFilesAdditionalProperty.from_dict(prop_dict)
    ...
    def __setitem__(self, key: str, value: SandboxCreateRequestFilesAdditionalProperty) -> None:
