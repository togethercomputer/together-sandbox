...
class MockFilesClient:
    ...
    async def create_file(
        ...
        raise NotImplementedError(
            "MockFilesClient.create_file() not implemented. Override this method in your test subclass."
        )
    ...
    async def read_file(
        ...
        """
        raise NotImplementedError(
            "MockFilesClient.read_file() not implemented. Override this method in your test subclass."
        )
    ...
    async def perform_file_action(
        ...
        """
        raise NotImplementedError(
            "MockFilesClient.perform_file_action() not implemented. Override this method in your test subclass."
        )
    ...
    async def delete_file(
        ...
        """
        raise NotImplementedError(
            "MockFilesClient.delete_file() not implemented. Override this method in your test subclass."
        )
    ...
    async def get_file_stat(
        ...
        """
        raise NotImplementedError(
            "MockFilesClient.get_file_stat() not implemented. Override this method in your test subclass."
        )
