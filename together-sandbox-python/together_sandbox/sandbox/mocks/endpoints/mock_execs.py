...
class MockExecsClient:
    ...
    body: CreateExecRequest,
        ...
        """
        raise NotImplementedError("MockExecsClient.create_exec() not implemented. Override this method in your test subclass.")
    ...
    self,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockExecsClient.list_execs() not implemented. Override this method in your test subclass.")
    ...
    id_: str,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockExecsClient.get_exec() not implemented. Override this method in your test subclass.")
    ...
    body: UpdateExecRequest,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockExecsClient.update_exec() not implemented. Override this method in your test subclass.")
    ...
    id_: str,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockExecsClient.delete_exec() not implemented. Override this method in your test subclass.")
    ...
    last_sequence: int | None = None,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockExecsClient.get_exec_output() not implemented. Override this method in your test subclass.")
    ...
    body: ExecStdin,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockExecsClient.exec_exec_stdin() not implemented. Override this method in your test subclass.")
    ...
    id_: str,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockExecsClient.connect_to_exec_web_socket() not implemented. Override this method in your test subclass.")
    ...
    self,
        ...
        the behavior needed for your test scenario.
        """
        raise NotImplementedError("MockExecsClient.stream_execs_list() not implemented. Override this method in your test subclass.")
        yield  # pragma: no cover