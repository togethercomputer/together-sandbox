 ...
 */
export const startExec = <ThrowOnError extends boolean = false>(options: Options<StartExecData, ThrowOnError>) => {
    return (options.client ?? client).post<StartExecResponses, StartExecErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const streamExecOutput = <ThrowOnError extends boolean = false>(options: Options<StreamExecOutputData, ThrowOnError>) => {
    return (options.client ?? client).sse.get<StreamExecOutputResponses, StreamExecOutputErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
