...
export type StartExecData = {
    /**
     * Optional start options (reserved for future use)
     */
    body?: ExecStart;
    path: {
        /**
    ...
    query?: never;
    url: '/api/v1/execs/{id}/start';
};

export type StartExecErrors = {
    /**
    ...
    404: _Error;
    /**
     * Conflict - Exec is not in a startable state. Only CREATED execs can be
     * started; RUNNING execs return 200 idempotently. Any other state
     * (EXITED, STOPPING, STOPPED) returns 409.
     *
     */
    409: _Error;
    /**
     * Internal Server Error - Failed to start exec
     */
    500: _Error;
    /**
     * Unexpected Error
...
export type StartExecError = StartExecErrors[keyof StartExecErrors];

export type StartExecResponses = {
    /**
     * Exec started successfully, or was already running. The response body
     * always reflects the current exec state.
     *
     */
    200: ExecItem;
};

export type StartExecResponse = StartExecResponses[keyof StartExecResponses];
...
export type GetExecOutputResponses = {
    /**
     * Exec output messages
     */
    200: Array<ExecStdout>;
};
...
export type StreamExecOutputData = {
    body?: never;
    path: {
        /**
         * Exec identifier
    ...
    url: '/api/v1/stream/execs/{id}/io';
};

export type StreamExecOutputErrors = {
    /**
     * Bad Request - Exec ID is required
     */
    400: _Error;
...
export type StreamExecOutputError = StreamExecOutputErrors[keyof StreamExecOutputErrors];

export type StreamExecOutputResponses = {
    /**
     * Server-sent events stream of exec output
     */
    200: ExecStdout;
};

export type StreamExecOutputResponse = StreamExecOutputResponses[keyof StreamExecOutputResponses];
